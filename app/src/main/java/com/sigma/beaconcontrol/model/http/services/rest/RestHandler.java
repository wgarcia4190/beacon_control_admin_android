...
import com.sigma.beaconcontrol.helpers.service.RestServiceHelper;
...
public class RestHandler {
    ...
    public RestHandler(String baseUrl, HttpScheme httpScheme) {
    ...
    public RestHandler setHttpMethod(@Nullable HttpMethod httpMethod) {
        if (httpMethod == null) {
    ...
    public RestHandler setCookie(@Nullable String cookie) {
    ...
    public RestHandler setHeaders(@NonNull HashMap<String, String> headers) {
        this.headers.set(headers);
        return this;
    }

    public RestHandler setBody(@NonNull String body) {
        if (this.parameters.get() == null) {
